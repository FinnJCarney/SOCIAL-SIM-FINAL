...
namespace instinctai.usr.behaviours
{
    ...
    public partial class Agent : MonoBehaviour
    {
        ...
        public ParentBehavior myParentScript;
        ...
        {
            myParentObj = transform.parent.gameObject;
            myParentScript = GetComponentInParent<ParentBehavior>();
            myParentScript.myChildBuffer = transform.GetChild(1).gameObject;
            transform.parent = null;
            Debug.Log("Got My Parent and Detached");
        }
